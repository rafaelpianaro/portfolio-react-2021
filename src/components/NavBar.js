    ...
    return (
        <header className="bg-red-600">
            <div className="container mx-auto flex justify-between">
                <nav className="flex">
                    <NavLink to="/" activeClassName="text-white" className="text-white inline-flex items-center py-6 px-6 mr-4 text-red-100 hover:text-green-800 text-4xl font-bold cursive tracking-widest">
                        Rafael
                    </NavLink>
